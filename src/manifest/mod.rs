...
pub struct Remote {
    ...
    /// Name of a Git branch (e.g. master or refs/heads/master). Remotes with their own revision will override the default revision.    
...
pub struct Project {
    ...
    /// Set to true to force this project to create the local mirror repository according to its path attribute (if supplied) rather than the name attribute. This attribute only applies to the local mirrors syncing, it will be ignored when syncing the projects in a client working directory.
...
struct ExtendProject {
    ...
    /// List of additional groups to which this project belongs. Same syntax as the corresponding element of project.
    #[serde(rename = "@groups")]
    groups: Option<String>,

    /// If specified, overrides the revision of the original project. Same syntax as the corresponding element of project.
    #[serde(rename = "@revision")]
    revision: Option<String>,

    /// If specified, overrides the remote of the original project. Same syntax as the corresponding element of project.
    #[serde(rename = "@remote")]
    remote: Option<String>,
}
